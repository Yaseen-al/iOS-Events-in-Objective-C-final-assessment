...
- (void)encodeWithCoder:(nonnull NSCoder *)aCoder {
    ...
    [aCoder encodeObject:_highResLink forKey:HIGHEST_LINK];
    [aCoder encodeObject:_localDate forKey:LOCAL_DATE];
}
...
- (nullable instancetype)initWithCoder:(nonnull NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        _highResLink = [aDecoder decodeObjectForKey:HIGHEST_LINK];
        _localDate = [aDecoder decodeObjectForKey:LOCAL_DATE];
    }
    return self;
}
